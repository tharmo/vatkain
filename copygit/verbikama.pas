...
type tverav=record ekasana,takia,vikasana:word;h,v,av:string[1];w:word;end;  //lisää viekä .takia - se josta etuvokaalit alkavat
...
mlist:=tstringlist.create;
  ...
  //writeln(fn,'<pre>');
  //for i:=0 to slist.count-1 do writeln('<li>',slist[i],'</li>');
  //writeln('</pre>VLuKI');
