...
type
  ...
  //TAppleDictionary = specialize TObjectDictionary<string, string>;
implementation
 type st16=array[1..15] of string;
 function BinarySearch(X: Integer; A: Array of st16): Integer;
 var
   L, R, I, Cur: Integer;
 begin
   Result := -1;
...
procedure test;
var ar:tarraystringstring;
 begin
     ar:=tarraystringstring.create;
